...
//
// Ported verbatim from Yomitan's japanese-transforms.js
// (https://github.com/yomidevs/yomitan/blob/master/ext/js/language/ja/japanese-transforms.js).
// This file alone is GPL-3.0; the engine (./languageTransformer.ts) is MIT.
// Keep this file isolated — only re-export through japaneseDeinflect.ts.
//
...
function irregularVerbSuffixInflections(
    ...
    const inflections: Rule<Condition>[] = [];
...
function specialHonorificMasuInflections(
    conditionsIn: Condition[],
    conditionsOut: Condition[],
): Rule<Condition>[] {
...
export const japaneseTransforms: LanguageTransformDescriptor<Condition> = {
    language: 'ja',
    conditions,
    transforms: {
        '-ば': {
